import { GroupedReportsByGateway, GroupedReportsByProject, IReport } from "../type/report";
...
export const groupReportByGateway = (reports: IReport[]): GroupedReportsByGateway => {
    return reports.reduce<GroupedReportsByGateway>((acc, report) => {
        ...
        const existingProjectIndex = acc[gatewayId].projects.findIndex(project => project.value === projectId)
